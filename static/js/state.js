...
$(function() {
  ...
  for (var i = 0; i < handles.length; i++) {
      options += '<option class="statechoice" value="' + handles[i] + '">' + handles[i] + '</option>';
  }
...
function selct_district($val)
{
 ...
 if($val=='Andhra Pradesh') {
  ...
  for (var i = 0; i < andhra.length; i++) {
      options += '<option class="districtchoice" value="' + andhra[i] + '">' + andhra[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < ap.length; i++) {
      options += '<option class="districtchoice" value="' + ap[i] + '">' + ap[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < assam.length; i++) {
      options += '<option class="districtchoice" value="' + assam[i] + '">' + assam[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < bihar.length; i++) {
      options += '<option class="districtchoice" value="' + bihar[i] + '">' + bihar[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < Chhattisgarh.length; i++) {
      options += '<option class="districtchoice" value="' + Chhattisgarh[i] + '">' + Chhattisgarh[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < dadra.length; i++) {
      options += '<option class="districtchoice" value="' + dadra[i] + '">' + dadra[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < daman.length; i++) {
      options += '<option class="districtchoice" value="' + daman[i] + '">' + daman[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < delhi.length; i++) {
      options += '<option class="districtchoice" value="' + delhi[i] + '">' + delhi[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < goa.length; i++) {
      options += '<option class="districtchoice" value="' + goa[i] + '">' + goa[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < gujarat.length; i++) {
      options += '<option class="districtchoice" value="' + gujarat[i] + '">' + gujarat[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < haryana.length; i++) {
      options += '<option class="districtchoice" value="' + haryana[i] + '">' + haryana[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < himachal.length; i++) {
      options += '<option class="districtchoice" value="' + himachal[i] + '">' + himachal[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < jammu.length; i++) {
      options += '<option class="districtchoice" value="' + jammu[i] + '">' + jammu[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < jharkhand.length; i++) {
      options += '<option class="districtchoice" value="' + jharkhand[i] + '">' + jharkhand[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < karnataka.length; i++) {
      options += '<option class="districtchoice" value="' + karnataka[i] + '">' + karnataka[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < kerala.length; i++) {
      options += '<option class="districtchoice" value="' + kerala[i] + '">' + kerala[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < mp.length; i++) {
      options += '<option class="districtchoice" value="' + mp[i] + '">' + mp[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < maharashtra.length; i++) {
      options += '<option class="districtchoice" value="' + maharashtra[i] + '">' + maharashtra[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < manipur.length; i++) {
      options += '<option class="districtchoice" value="' + manipur[i] + '">' + manipur[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < meghalaya.length; i++) {
      options += '<option class="districtchoice" value="' + meghalaya[i] + '">' + meghalaya[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < mizoram.length; i++) {
      options += '<option class="districtchoice" value="' + mizoram[i] + '">' + mizoram[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < nagaland.length; i++) {
      options += '<option class="districtchoice" value="' + nagaland[i] + '">' + nagaland[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < orissa.length; i++) {
      options += '<option class="districtchoice" value="' + orissa[i] + '">' + orissa[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < puducherry.length; i++) {
      options += '<option class="districtchoice" value="' + puducherry[i] + '">' + puducherry[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < punjab.length; i++) {
      options += '<option class="districtchoice" value="' + punjab[i] + '">' + napunjabgaland[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < rajasthan.length; i++) {
      options += '<option class="districtchoice" value="' + rajasthan[i] + '">' + rajasthan[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < sikkim.length; i++) {
      options += '<option class="districtchoice" value="' + sikkim[i] + '">' + sikkim[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < tn.length; i++) {
      options += '<option class="districtchoice" value="' + tn[i] + '">' + tn[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < telangana.length; i++) {
      options += '<option class="districtchoice" value="' + telangana[i] + '">' + telangana[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < tripura.length; i++) {
      options += '<option class="districtchoice" value="' + tripura[i] + '">' + tripura[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < up.length; i++) {
      options += '<option class="districtchoice" value="' + up[i] + '">' + up[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < uttarakhand.length; i++) {
      options += '<option class="districtchoice" value="' + uttarakhand[i] + '">' + uttarakhand[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
  ...
  for (var i = 0; i < wb.length; i++) {
      options += '<option class="districtchoice" value="' + wb[i] + '">' + wb[i] + '</option>';
  }
  $('#secondlist').html(options);
  });
  }
